                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="kontak_hp" class="col-md-4 col-form-label text-md-right">{{ __('kontak hp') }}</label>

                            <div class="col-md-6">
                                <input id="kontak_hp" type="kontak_hp" class="form-control @error('kontak_hp') is-invalid @enderror" name="kontak_hp" value="{{ old('kontak_hp') }}" required autocomplete="kontak_hp" autofocus>
